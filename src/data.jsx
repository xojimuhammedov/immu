...
import MemberEleven from './assets/member11.jpg'
import MemberTwelf from './assets/member12.jpg'
...
import CouncilThree from './assets/council3.jpg'
import CouncilFour from './assets/council4.jpg'
import CouncilFive from './assets/council5.jpg'
import CouncilSix from './assets/council6.jpg'
import CouncilSeven from './assets/council7.jpg'
import CouncilEight from './assets/council8.jpg'
import CouncilNine from './assets/council9.jpg'
import CouncilTen from './assets/council10.jpg'
import CouncilEleven from './assets/council11.jpg'
import CouncilTwelf from './assets/council12.jpg'
import CouncilThirsteen from './assets/council13.jpg'
import CouncilFourteen from './assets/council14.jpg'
...
export const members = [
  {
    ...
    description_uz:
      "Iskandar Tursunov islomiy moliya bo‘yicha kuchli akademik tayyorgarlikka ega mutaxassis bo‘lib, INCEIF University (Malayziya)da Master in Islamic Finance Practice (MIFP) darajasini olgan. Shuningdek, u Istanbul Sabahattin Zaim University (Turkiya)da islomiy moliya bo‘yicha Erasmus almashuv dasturida qatnashgan hamda Toshkent Moliya Institutida “Buxgalteriya hisobi va audit” yo‘nalishida bakalavr darajasini olgan. U AAOIFI Certified Shari'ah Advisor and Auditor (CSAA) sertifikatiga ega bo‘lib, shariat boshqaruvi va muvofiqlik (compliance) yo‘nalishlarida e’tirof etilgan kompetensiyasini namoyon etadi. Uning professional tajribasi O‘zbekistonning iqtisodiy siyosat institutlaridagi yuqori lavozimlari bilan ajralib turadi. 2024-yildan buyon u Al Muamalat Consulting kompaniyasining asoschisi va direktori sifatida islomiy moliya bo‘yicha maslahat, sukuk strukturasi va kadrlar salohiyatini oshirish loyihalariga rahbarlik qilmoqda.",
    description_en:
      "Iskandar Tursunov is an Islamic finance specialist with a strong academic foundation, holding a Master in Islamic Finance Practice (MIFP) from INCEIF University (Malaysia), complemented by an Erasmus Exchange at Istanbul Sabahattin Zaim University (Türkiye) and a Bachelor’s degree in Accounting and Audit from Tashkent Financial Institute. He is an AAOIFI Certified Shariah Advisor & Auditor (CSAA). Since 2024, he has served as Founder & CEO of Al Muamalat Consulting, leading advisory engagements in Shariah compliance, sukuk structuring, and capacity development.",
  },

  {
    ...
    description_uz:
      "Hayotjon Azimov islomiy moliya sohasida katta tajribaga ega bo‘lgan, kuchli akademik va kasbiy tayyorgarlikka ega mutaxassisdir. U INCEIF (Malayziya)dan Chartered Islamic Finance Professional (CIFP) malakasini olgan hamda Toshkent davlat iqtisodiyot universitetida iqtisodiyot yo‘nalishida tahsil olgan. U AAOIFI Certified Shari'ah Advisor and Auditor (CSAA) sertifikatiga ega. Uning ish tajribasi bank, kapital bozorlari va takaful sohalarini qamrab olib, Al Muamalat Consultingda Maslahat yo‘nalishi rahbari sifatida Islomiy banklar to‘g‘risidagi qonun loyihasi, Islomiy bank darchalari, shuningdek blokcheyn va tokenizatsiya texnologiyalarining shariatga muvofiq qo‘llanishi bo‘yicha maslahatlar bergan. Avvalroq BNP Paribas Malaysia va CIMB Islamicda sukuk, treasury, ALM va derivativlar yo‘nalishlarida chuqur tajriba to‘plagan.",
    description_en:
      "Hayotjon Azimov is a seasoned Islamic finance professional holding a Chartered Islamic Finance Professional (CIFP) qualification from INCEIF (Malaysia) and formal economics training from Tashkent State University of Economics. He is an AAOIFI Certified Shariah Advisor and Auditor (CSAA). His experience spans banking, capital markets, and takaful, including leadership roles at Al Muamalat Consulting, Apex OILA Takaful, BNP Paribas Malaysia, and CIMB Islamic. He is recognized for strong technical expertise, stakeholder management, and high-standard Islamic finance advisory.",
  },
  {
    id: 3,
    ...
    description_uz:
      "Baxtiyorjon Fayzullayev moliya va islomiy bank ishi yo‘nalishida faoliyat yurituvchi mutaxassis bo‘lib, Jahon iqtisodiyoti va diplomatiya universitetida “Xalqaro iqtisodiyot va menejment” yo‘nalishi bo‘yicha bakalavr darajasini olgan. U AAOIFI Certificate of Proficiency in Shari’ah Standards (CPSS) hamda Financial Modeling & Valuation Analyst (FMVA) sertifikatlariga ega. Hozirda Al Muamalat Consultingda Katta maslahatchi sifatida Islomiy Bank Darchalarini tashkil etish, islomiy moliya mahsulotlarini strukturaviy ishlab chiqish va trening dasturlarini muvofiqlashtirish bilan shug‘ullanadi. Avvalroq KPMG Uzbekistan va Investitsiyalar, sanoat va savdo vazirligida professional va amaliy tajriba orttirgan.",
    description_en:
      "Bakhtiyorjon Fayzullaev is a finance and Islamic banking professional with a Bachelor’s degree in International Economics and Management from the University of World Economy and Diplomacy. He holds the AAOIFI Certificate of Proficiency in Shari’ah Standards (CPSS) and the FMVA credential. Currently a Senior Associate at Al Muamalat Consulting, he advises on Islamic Banking Windows, supports Islamic finance product structuring and documentation, and coordinates training programs. He is distinguished by strong analytical skills, disciplined documentation, and high-quality advisory support.",
  },
...

  {
    ...
    certificate:
      "Certificate of Proficiency in Shari’ah Standards (CPSS) & Certificate of Proficiency in Financial Accounting Standards (CPFAS)",
    description_uz:
      "Nurali Saidov Toshkent Davlat Iqtisodiyot Universitetining menejment yo‘nalishi bitiruvchisi bo‘lib, bank-moliya va real sektor kesishmasida shakllangan keng ko‘lamli amaliy tajribaga ega mutaxassisdir. U faoliyatini davlat tashkilotida iqtisodchi sifatida boshlab, keyinchalik xususiy korxonalarda buxgalteriya va moliyaviy boshqaruv yo‘nalishlarida mas’ul lavozimlarda, jumladan bosh hisobchi, bosh hisobchi o‘rinbosari, direktor va boshqa rahbarlik pozitsiyalarida samarali faoliyat yuritgan. Savdo-sanoat tizimidagi tajribasi unga korporativ boshqaruv, moliyaviy hisobot va nazorat, shuningdek tashkilotlar faoliyatini muvofiqlashtirish bo‘yicha mustahkam ko‘nikmalarni shakllantirgan. U AAOIFIning CPSS va CPFAS sertifikatlariga ega bo‘lib, islomiy moliya va islomiy moliyaviy hisob standartlari bo‘yicha professional bilim va amaliy yondashuvini tasdiqlaydi. Umuman olganda, Nurali Saidov yuqori mas’uliyat, tizimli fikrlash va amaliy natijaga yo‘naltirilgan professional yondashuvi bilan ajralib turadi.",
    description_en:
      "Nurali Saidov is a graduate of the Tashkent State University of Economics with a degree in Management and a specialist with extensive practical experience developed at the intersection of banking, finance, and the real economy. His career spans from working as an economist in a public institution to holding senior accounting and financial management roles in private companies, including Chief Accountant, Deputy Chief Accountant, Director, and other leadership positions. His trade and industry experience has strengthened his competencies in corporate governance, financial reporting and control, and organizational coordination. He holds AAOIFI certifications in Shari’ah Standards (CPSS) and Financial Accounting Standards (CPFAS), confirming his professional expertise. Overall, he is recognized for responsibility, structured thinking, and a results-oriented professional approach.",
  },

  {
    ...
    description_uz:
      "Onaxon Raximova buxgalteriya hisobi, audit va moliyaviy nazorat sohalarida mustahkam akademik tayyorgarlikka ega mutaxassis bo‘lib, Toshkent davlat transport universitetida “Buxgalteriya hisobi va audit” yo‘nalishida bakalavr darajasini hamda Toshkent Moliya institutida “Audit” yo‘nalishi bo‘yicha magistr darajasini olgan. Hozirda u Toshkent iqtisodiyot universitetida PhD bosqichida ilmiy izlanish olib bormoqda. Mehnat faoliyati davomida u oliy ta’lim muassasasida iqtisodchi sifatida iqtisodiy tahlil, rejalashtirish va hisob-kitob jarayonlarida ishtirok etgan, keyinchalik Toshkent shahar hokimiyatida investitsiya yo‘nalishidagi bo‘limda bosh hisobchi sifatida moliyaviy hisobot, budjet intizomi va nazorat jarayonlarini yuritgan. Hozirda u “Xadicha Kubro” ayol-qizlar o‘rta maxsus islom ta’lim muassasasida bosh hisobchi bo‘lib, moliyaviy boshqaruv, hisob siyosati va hisobotlarning to‘g‘ri yuritilishini ta’minlab kelmoqda. Shuningdek, u AAOIFIning Certificate of Proficiency in Financial Accounting Standards (CPFAS) sertifikatiga ega bo‘lib, islomiy moliyaviy hisobot standartlari bo‘yicha professional bilim va malakasini tasdiqlaydi. Umuman olganda, Onaxon Raximova mas’uliyatli yondashuvi, tartib-intizomi, tizimli fikrlashi va yuqori professionalligi bilan ajralib turadigan ishonchli mutaxassisdir.",
    description_en:
      "Onakhon Rakhimova is a specialist with a strong academic background in accounting, auditing, and financial control. She earned a Bachelor’s degree in Accounting and Audit from Tashkent State Transport University and a Master’s degree in Audit from the Tashkent Institute of Finance. She is currently pursuing PhD-level research at the Tashkent State University of Economics. Throughout her career, she has worked as an economist in a higher education institution, contributing to economic analysis, planning, and settlement processes. She later served as Chief Accountant in an investment-focused department of the Tashkent City Administration, overseeing financial reporting, budget discipline, and control procedures. She currently works as Chief Accountant at the “Xadicha Kubro” women’s secondary specialized Islamic education institution, ensuring effective financial management, sound accounting policies, and accurate reporting. She also holds the AAOIFI Certificate of Proficiency in Financial Accounting Standards (CPFAS), confirming her professional competence in Islamic financial reporting standards. Overall, she is a reliable professional distinguished by responsibility, strong discipline, structured thinking, and high standards of professionalism.",
  },

  {
    ...
    certificate:
      "Certificate of Proficiency in Shari’ah Standards (CPSS) & Certificate of Proficiency in Financial Accounting Standards (CPFAS)",
    description_uz:
      "Oybek Abdurahimov bank ishi va xalqaro valyuta-kredit munosabatlari yo‘nalishlarida mustahkam akademik tayyorgarlikka ega, moliya sohasida ko‘p yillik amaliy tajriba to‘plagan mutaxassisdir. U Toshkent Moliya institutida “Bank ishi” yo‘nalishi bo‘yicha bakalavr hamda “Xalqaro valyuta-kredit munosabatlari” yo‘nalishi bo‘yicha magistr darajasini olgan. Professional faoliyatini bank tizimida boshlagan bo‘lib, “Asakabank”ning hududiy bo‘linmasida buxgalteriya yo‘nalishida ishlashdan so‘ng bosh hisobchi o‘rinbosari sifatida moliyaviy hisobot, buxgalteriya nazorati va bank operatsiyalarini hisobga olish jarayonlarida yetakchi vazifalarni bajargan. Keyinchalik “Aloqabank”da hududiy filial bosh buxgalteri sifatida buxgalteriya hisobi va ichki nazorat tizimlarini yuritgan, so‘ng bank markazi rahbari sifatida operatsion boshqaruv va moliyaviy intizomni ta’minlash bo‘yicha rahbarlik tajribasini shakllantirgan. Hozirda u xususiy korxonada auditor sifatida faoliyat yuritib, moliyaviy tekshiruvlar, hisobotlar ishonchliligi va risklarni baholash bo‘yicha professional xizmatlar ko‘rsatmoqda. Shuningdek, u AAOIFIning CPSS va CPFAS sertifikatlariga ega bo‘lib, shariat va islomiy moliyaviy hisob standartlari bo‘yicha kasbiy bilimini tasdiqlaydi. Umuman olganda, Oybek Abdurahimov mas’uliyat, aniqlik, tizimli yondashuv va natijadorlikka yo‘naltirilgan professional ish uslubi bilan ajralib turadigan ishonchli mutaxassisdir.",
    description_en:
      "Oybek Abdurakhimov is a finance professional with a strong academic background in banking and international monetary and credit relations, supported by many years of practical experience in the financial sector. He earned a Bachelor’s degree in Banking and a Master’s degree in International Monetary and Credit Relations from the Tashkent Institute of Finance. He began his career in the banking system at a regional branch of Asakabank, initially working in accounting and later serving as Deputy Chief Accountant, where he held leading responsibilities in financial reporting, accounting control, and banking operations. He later worked at Aloqabank as Chief Accountant of a regional branch, overseeing accounting and internal control systems, and subsequently as Head of a bank center, developing strong leadership experience in operational management and ensuring financial discipline. He currently works as an auditor in a private company, providing professional services in financial inspections, assurance of reporting reliability, and risk assessment. He also holds two AAOIFI certificates — Certificate of Proficiency in Shari’ah Standards (CPSS) and Certificate of Proficiency in Financial Accounting Standards (CPFAS) — confirming his professional knowledge of Shari’ah standards and Islamic financial accounting standards. Overall, he is a reliable specialist distinguished by responsibility, accuracy, a structured approach, and a results-oriented professional work style.",
  },

  {
    ...
    description_en:
      "Nilufar Babanazarova is a specialist with a strong academic background in banking as well as bank and credit risk management, with consistent practical experience across the banking, audit, and education sectors. She earned a Bachelor’s degree in Banking and a Master’s degree in Bank and Credit Risks from the Tashkent Institute of Finance. During her career, she worked at Hamkorbank in financial planning and cost control related to administrative and operational expenses, and later at Smart Audit as an accounting consultant and audit assistant, gaining experience in financial statement analysis, audit support, and accounting advisory. She has also served as a lecturer at the Banking and Finance Academy of the Republic of Uzbekistan and is currently conducting doctoral research there. She holds the AAOIFI Certificate of Proficiency in Shari’ah Standards (CPSS), confirming her professional knowledge of Islamic finance standards. Overall, she is distinguished by structured thinking, responsibility, strong analytical capability, and a continuous commitment to professional development.",
  },
...

  {
    ...
    description_en:
      "Pakhlavon Chinpulatov is a specialist with a solid academic background in international economics and finance, and practical experience in capital market infrastructure. He earned a Bachelor’s degree in International Economics and Management from the University of World Economy and Diplomacy and is currently pursuing a Master’s degree in Corporate Finance and Securities Markets at the Banking and Finance Academy of the Republic of Uzbekistan. Throughout his professional career, he has held various positions at the Central Securities Depository, where he developed strong hands-on expertise in post-trade market infrastructure, settlement and custody processes, and working with institutional clients. He currently serves as Head of the Department for Services to Foreign Nominee Holders and SWIFT Messaging, leading operational processes aligned with international practice and ensuring service quality and strict adherence to established procedures. He also holds the AAOIFI Certified Shari’ah Advisor and Auditor (CSAA) certificate, confirming his professional competence in Shari’ah compliance, governance, and audit in line with Islamic finance principles. Overall, he is a promising and reliable professional distinguished by structured thinking, a high sense of responsibility, strong adherence to international standards, and a results-oriented approach.",
  },
...

  {
    ...
    description_uz:
      "Umrbek Rajabov iqtisodiyot va islom moliyasi yo‘nalishlarida mustahkam akademik tayyorgarlikka ega bo‘lib, professional rivojlanishga izchil yondashuvi bilan ajralib turadigan mutaxassisdir. U Urganch davlat universitetida “Iqtisodiyot (tarmoqlar va sohalar)” yo‘nalishi bo‘yicha bakalavr darajasini olgan hamda INCEIF Universitetida “Islom moliyasi” yo‘nalishi bo‘yicha magistratura bosqichini tamomlagan. Shuningdek, u AAOIFIning Certificate of Proficiency in Shari’ah Standards (CPSS) sertifikatiga ega bo‘lib, islomiy moliya standartlari bo‘yicha professional bilim va malakasini tasdiqlaydi. Umuman olganda, Umrbek Rajabov puxta akademik baza, tizimli fikrlash va yuqori mas’uliyatga tayangan holda islomiy moliya amaliyotini rivojlantirishga hissa qo‘shishga yo‘naltirilgan, ishonchli va professional mutaxassis sifatida e’tirof etiladi.",
    description_en:
      "Umrbek Rajabov is a specialist with a solid academic foundation in economics and Islamic finance, characterized by a consistent commitment to professional development. He earned a Bachelor’s degree in Economics (sectors and industries) from Urgench State University and completed a Master’s degree in Islamic Finance at INCEIF University. He also holds the AAOIFI Certificate of Proficiency in Shari’ah Standards (CPSS), confirming his professional knowledge and competence in Islamic finance standards. Overall, Umrbek Rajabov is recognized as a reliable and professional specialist distinguished by strong academic preparation, structured thinking, and a high sense of responsibility, with a clear focus on contributing to the advancement of Islamic finance practice.",
  },
...
export const specialCouncilData = [
  {
    ...
    description_en:
      "Abiev Khikmatilla Hasanovich is an Islamic scholar, deputy imam, and researcher with extensive experience in Islamic sciences, hadith, and tafsir. He began his educational journey in Margilan. In 1997, he completed both his bachelor’s and master’s degrees at Darul Ulum Islamic University in Karachi, Islamic Republic of Pakistan. He also studied at an Islamic educational institution in Andijan. Over the years, he has served as an imam-khatib, deputy imam, and researcher. Since 2020, he has been working as a junior research officer at the Imom Termiziy International Scientific-Research Center, where he actively conducts research in Islamic sciences, hadith, and tafsir.",
  },
  {
    id: 2,
    ...
    description_en:
      "Kodirov Hasan Karimberdiyevich is a specialist with deep knowledge in Islamic sciences and Islamic education. He graduated from the “Khoja Ahror Vali” secondary specialized Islamic educational institution in Samarkand region and completed his studies at the Tashkent Islamic Institute named after Imam Bukhari. Additionally, he earned his master’s degree at the Tashkent State University of Uzbek Language and Literature named after Alisher Navoi. Throughout his career, he has worked as an imam-khatib at the “Khoja Abdi Berun” mosque in Samarkand region, and served as deputy imam and imam-khatib at various mosques in Tashkent including “Siroj-Solih”, “Yunusobod”, and “Mulla Kholmirza ota”. He has also taught at the “Kokaldosh” secondary specialized educational institution and worked as a senior lecturer (part-time) at the Tashkent Islamic Institute. Currently, he serves as imam-khatib at the “Siroj-Solih” mosque in Olmazor district, Tashkent. Overall, he is recognized as a reliable specialist and educator who combines Islamic education and religious service with extensive practical experience.",
  },
  {
    id: 3,
    ...
    image: CouncilThree,
    description_uz:
      "Ismoilov Mas’udxon Mahdievich — islomshunoslik va islom sivilizatsiyasini o‘rganish sohasida kuchli akademik tayyorgarlikka ega mutaxassis. U Toshkent Islom institutida bakalavr, O‘zbekiston Milliy universitetida magistratura bosqichlarini tamomlab, islomshunos, imom-xatib, arab tili o‘qituvchisi hamda tarixshunos-madashunos mutaxassisliklarini egallagan. Tarix fanlari bo‘yicha PhD ilmiy darajasiga va dotsent ilmiy unvoniga ega. U O‘zbekiston Respublikasi Fanlar akademiyasi Sharqshunoslik instituti hamda O‘zbekiston Milliy universitetida ilmiy va pedagogik faoliyat olib borgan. Hozirda O‘zbekiston xalqaro islomshunoslik akademiyasining “Islomshunoslik va islom sivilizatsiyasini o‘rganish (ICESCO)” kafedrasi dotsenti sifatida faoliyat yuritmoqda. Ismoilov Mas’udxon Mahdievich Gerda Henkel jamg‘armasi qo‘llab-quvvatlagan qo‘lyozmalarni ilmiy elektron katalogini yaratish loyihasi, shuningdek O‘zbekiston Islom sivilizatsiyasi markazining ilmiy loyihalari rahbari va ishtirokchisi hisoblanadi. U noyob qo‘lyozmalar va tarixiy hujjatlar bilan fondlarni boyitish bo‘yicha ekspert bo‘lib, “International Agriculture University”ning “Iqtisodiyot asoslari” kursi hamda AAOIFI sertifikatlariga ega. Umuman olganda, Ismoilov Mas’udxon Mahdievich ilmiy merosni tadqiq etish, saqlash va zamonaviy ilmiy yondashuvlar asosida rivojlantirishga salmoqli hissa qo‘shib kelayotgan yetuk olim va pedagog sifatida e’tirof etiladi.",
    description_en:
      "Ismoilov Mas’udkhon Mahdievich is a specialist with strong academic training in Islamic studies and the study of Islamic civilization. He completed his Bachelor’s degree at Tashkent Islamic Institute and his Master’s degree at the National University of Uzbekistan, obtaining qualifications as an Islamic studies scholar, imam-khatib, Arabic language instructor, and historian–manuscript specialist. He holds a PhD in History and the academic title of Associate Professor. He has carried out research and teaching activities at the Institute of Oriental Studies of the Academy of Sciences of Uzbekistan and the National University of Uzbekistan. He is currently serving as an Associate Professor at the Department of Islamic Studies and the Study of Islamic Civilization (ICESCO) at the International Islamic Academy of Uzbekistan. Ismoilov Mas’udkhon Mahdievich has participated in research projects supported by the Gerda Henkel Foundation, including the creation of a scholarly electronic catalogue of manuscript collections, and has served as a project leader and participant in academic initiatives of the Center of Islamic Civilization in Uzbekistan. He is also an expert involved in enriching institutional manuscript collections with rare manuscripts and historical documents. In addition, he holds certificates from the International Agriculture University in “Fundamentals of Economics” and from AAOIFI (Accounting and Auditing Organization for Islamic Financial Institutions). Overall, he is recognized as a distinguished scholar and educator who makes a significant contribution to the research, preservation, and development of Islamic intellectual heritage through modern academic approaches.",
  },
  {
    id: 4,
    ...
    description_en:
      "Abdullaev Botirjon Kasimovich is a historian with a PhD in History and a junior research fellow at the Department of the Study of Eastern Peoples and Cultures of the Abu Rayhan Beruni Institute of Oriental Studies. He completed his studies at the Faculty of Physics of Tashkent State University and undertook a two-year Arabic language program at the Faculty of Oriental Studies. He has participated as a project leader and contributor in several research initiatives in Uzbekistan, including projects of the Center of Islamic Civilization in Uzbekistan and the Astronomy Institute of the Academy of Sciences. He is also an expert in enriching institutional collections with rare manuscripts, lithographic books, and historical documents, and has presented papers at international conferences in Germany, Turkey, and Afghanistan. He holds an AAOIFI Certificate, demonstrating his expertise in applying international standards of Islamic finance. Overall, he is recognized as a dedicated scholar and expert contributing to the research, preservation, and development of historical and Islamic intellectual heritage.",
  },
  {
    id: 5,
    ...
    description_en:
      "Ummatov Jamoliddin Kodirovich is an imam-khatib, Islamic scholar, and Arabic language teacher. He studied at the Sayyid Muhyiddin Makhdum Secondary Islamic Education Institution and the Tashkent Islamic Institute, and completed his Master’s studies at the University of Exact and Social Sciences. He has served as an imam-khatib at several mosques and religious centers in Jizzakh region, including the “Havastlik” Jome Mosque. He currently works as an instructor at the Qur’an and Tajwid Learning Center in Jizzakh. Overall, Jamoliddin Ummatov is recognized as a highly experienced specialist in religious education and Arabic language instruction.",
  },
  {
    id: 6,
    ...
    description_en:
      "Khalilov Shavkatjon Bakhrom ogli is a specialist with deep knowledge in Islamic law and finance. He completed his bachelor’s degree at the Tashkent Islamic Institute and his master’s and doctoral studies at the International Islamic Academy of Uzbekistan. He holds an AAOIFI Certified Shari’ah Expert (CSE) certificate and has successfully completed the SS (Shari’ah Standards) and IFSD (Islamic Finance and Shari’ah Objectives) modules. These certifications confirm his professional expertise in Islamic finance and Shari’ah standards. Throughout his career, he has gained practical experience as an Islamic finance specialist at MAXZAN FINANS and Assodiq LLC, developing key skills in implementing Islamic finance principles into business practice. He currently works as an Islamic finance specialist at MAXZAN FINANS and Assodiq LLC. Overall, Shavkatjon Khalilov is a qualified and reliable specialist who combines Islamic law and finance in both practical and academic fields, with expertise in international standards.",
  },
  {
    id: 7,
    ...
    description_en:
      "Aminov Khamidulla Abdirahimovich is a specialist with deep knowledge in Islamic studies and history. He obtained his bachelor’s degree from the Tashkent Islamic Institute named after Imam Bukhari and his master’s degree from the Tashkent State Institute of Culture named after Abdulla Qodiri. He holds the academic degrees of Candidate of Historical Sciences and Doctor of Historical Sciences (DSc). Throughout his career, he has worked at the Abu Rayhan Beruni Institute of Oriental Studies of the Academy of Sciences of Uzbekistan as a postgraduate student, junior research fellow, and senior research fellow. He has lectured on the commentaries of “Sahih al-Bukhari” at the International Islamic Academy of Uzbekistan. He holds an AAOIFI certificate and a “Fundamentals of Economics” course certificate, confirming his professional knowledge in Islamic finance. Internationally, he has participated in scientific conferences in Germany and Turkey, actively contributed to the creation of an electronic manuscript catalogue under the Gerda Henkel Foundation project, and served as a leader and participant in research projects of the Center of Islamic Civilization of Uzbekistan. He currently works as a senior research fellow in the “Islamic Studies and Social Thought” department at the Institute of Oriental Studies. Overall, Aminov Khamidulla Abdirahimovich is recognized as a renowned scholar and reliable specialist who combines Islamic studies, history, and Islamic finance with international experience.",
  },
  {
    id: 8,
    ...
    description_en:
      "Ganiyev Abduvosi Abdumalikovich is a specialist with deep knowledge in Islamic law. He studied at the Imam al-Bukhari Madrasa in the Samarkand region and obtained his bachelor’s degree in Jurisprudence (Islamic Law) and his master’s degree in the Legal System of Muslim Countries from the Tashkent Islamic University. Throughout his career, he has worked at the “Kokaldosh” secondary specialized Islamic educational institution as a teacher, deputy director for spiritual and educational affairs, and head of the Youth Affairs, Spirituality, and Education Department. He holds an AAOIFI certificate, confirming his professional knowledge in Islamic finance. Currently, he serves as deputy director for spiritual and educational affairs at the “Kokaldosh” secondary specialized Islamic educational institution. Overall, Abduvosi Ganiyev is recognized as a reliable specialist and educator who combines Islamic law and educational work with extensive practical experience.",
  },
  {
    id: 9,
    ...
    description_en:
      "Kholmominov Jaloliddin Yusupalievich is a specialist with deep knowledge in Islamic studies and Islamic law. He completed his bachelor’s degree at the Tashkent Islamic Institute and his master’s degree at the International Islamic Academy of Uzbekistan. Throughout his career, he has worked at the “Kokaldosh” secondary specialized Islamic educational institution as a teacher of fiqh (Islamic jurisprudence), chairman of the methodological association, deputy director for academic affairs, and head of the educational and methodological department. Additionally, he has served as deputy imam at the “Ahmadjon qori” mosque in Olmazor district, Tashkent, and as imam-khatib at the “Kohota Buzruk” mosque. He holds an AAOIFI Shari’ah Standards certificate, confirming his professional knowledge in Islamic finance. Currently, he works as a senior lecturer at the “Kokaldosh” secondary specialized Islamic educational institution and is a member of the Council of Ulama of the Muslim Board of Uzbekistan. Overall, Jaloliddin Kholmominov is recognized as a respected teacher and reliable specialist who combines Islamic sciences, fiqh, and educational work with extensive practical experience.",
  },
  {
    id: 10,
    ...
    description_en:
      "Abduqodirov Muhammadrakhim Abdullayevich is a specialist with deep knowledge in Islamic studies and Islamic sciences. He learned his initial knowledge of fiqh (Islamic jurisprudence) and Arabic language from his father, Abdullah domla. He completed his studies at the “Sayyid Muhyiddin Mahdum” Islamic secondary specialized educational institution in Andijan region and obtained his bachelor’s degree from the Tashkent Islamic Institute named after Imam Bukhari, as well as his master’s degree from the University of Exact and Social Sciences. Throughout his career, he has worked at various mosques in Tashkent in positions including muezzin, deputy imam, and imam-khatib, serving at the “Siroj Solih”, “Chimir Ota”, “Abu Hurayra”, and “Islomobod” mosques. He completed a specialized course according to AAOIFI standards and obtained a certificate, confirming his professional knowledge in Islamic finance. Currently, he serves as imam-khatib at the “Dorussalom” mosque in Shaykhontohur district, Tashkent. Overall, he is recognized as a reliable specialist and imam-khatib who combines Islamic sciences and religious service with extensive practical experience.",
  },
  {
    id: 11,
    ...
    description_en:
      "Niyazqulov Abdugafur Rabimqulovich is a specialist with deep knowledge in Islamic studies, fiqh (Islamic jurisprudence), and the Arabic language. He studied fiqh and Arabic at the “Sayyid Muhyiddin Mahdum” secondary specialized Islamic educational institution in Andijan, continued his education at Andijan State University and the Tashkent Islamic Institute, and completed his master’s degree at the University of Exact and Social Sciences. Throughout his career, he worked as a teacher of Tafsir at the “Sayyid Muhyiddin Mahdum” secondary specialized Islamic educational institution. He holds an AAOIFI international certificate, confirming his professional knowledge in Islamic finance. Currently, he serves as a chief specialist at the Fatwa Center of the Muslim Board of Uzbekistan. Overall, he is recognized as a reliable specialist and scholar who combines Islamic studies, fiqh, and fatwa issuance with extensive practical experience.",
  },
  {
    id: 12,
    ...
    description_en:
      "Boborakhimov Zikriyo Karimberdiyevich is a specialist with deep knowledge in Islamic studies and Shari’ah sciences. He studied Shari’ah sciences at the “Sayyid Muhyiddin Mahdum” Islamic educational institution, continued his education at the Tashkent Islamic Institute, and completed his master’s degree at Oriental University. Throughout his career, he served in a religious capacity as imam-khatib at the “Madamin-Qori” mosque. He holds an AAOIFI certificate, confirming his professional knowledge in Islamic finance. Currently, he works as a leading specialist at the Fatwa Center under the Muslim Board of Uzbekistan. Overall, he is recognized as a reliable specialist who combines Islamic studies, Shari’ah sciences, and fatwa issuance with extensive practical experience.",
  },
  {
    id: 13,
    ...
    description_en:
      "Ibragimov Muhammadjon Sharipovich is a specialist with deep knowledge in Islamic studies and fiqh (Islamic jurisprudence). He initially learned the basic sciences of the Qur’an and tajweed from his grandfather and father. He studied fiqh and Islamic sciences at the “Sayyid Muhyiddin Mahdum” secondary specialized Islamic educational institution in Andijan, continued his education at the Tashkent Islamic Institute, and completed his master’s degree at Oriental University. He holds an AAOIFI international certificate, confirming his professional knowledge in Islamic finance. Currently, he works as a leading specialist at the Fatwa Center of the Muslim Board of Uzbekistan. Overall, Muhammadjon Ibragimov is recognized as a reliable specialist who combines Islamic studies, fiqh, and fatwa issuance, having been raised in the Islamic tradition.",
  },
  {
    id: 14,
