import Person1 from './assets/iskandar.jpg'
...
export const members = [
    {
      ...
      image: Person1, 
      description_en:"Tursunov Iskandar holds a master’s degree in Islamic finance from INCEIF University in Kuala Lumpur, Malaysia. He also studied Islamic finance at Istanbul Sabahattin Zaim University in Türkiye. He has many years of experience in the banking, insurance, and government sectors. Furthermore, he is a columnist who frequently writes articles on Islamic finance and conducts training sessions in this area. Iskandar aims to actively participate with his team in the widespread development of Islamic finance in Uzbekistan and Central Asia. His goal is to increase the literacy of the population and entrepreneurs on Islamic finance, thereby improving living conditions and ensuring sustainable economic growth through Islamic finance. He believes that social Islamic finance is an important tool for reducing poverty and is dedicated and enthusiastic about its full implementation in practice.",
      description_uz:"Tursunov Iskandar Malayziyadagi INCEIF Universitetida Islomiy moliya bo‘yicha magistrlik darajasini olgan. Shuningdek, u Turkiyaning Istanbul Sabaxattin Zaim universitetida Islomiy moliya bo‘yicha tahsil olgan. U bankchilik, sug‘urta va davlat sektorida ko‘p yillik tajribaga ega. Iskandar o‘z jamoasi bilan O‘zbekiston va Markaziy Osiyoda Islomiy moliyani keng yoyishda faol ishtirok etishni maqsad qilgan. Uning maqsadi aholi va tadbirkorlarning Islomiy moliya bo‘yicha savodxonligini oshirish orqali hayot sharoitlarini yaxshilash va Islomiy moliya orqali barqaror iqtisodiy o‘sishni ta’minlashdir. U ijtimoiy Islom moliyasini qashshoqlikni kamaytirish uchun muhim vosita deb hisoblaydi va uni amaliyotda to‘liq joriy qilishga sodiq va ishtiyoqmanddir."
    },
    {
      id: 2,
      ...
      email: 'sattarov@immu.uz',
      image: Person2,
      description_en:"KHAMID RAKHAMTOV earned a master's degree in Islamic finance from International Islamic University Malaysia University in Kuala Lumpur, Malaysia. He has extensive expertise in the financial services, insurance, and the state industries. In addition, he is an academic who often prepares articles on Islamic finance and leads many training sessions in this field as well. Khamid intends to actively contribute, alongside his team, in the general growth of Islamic finance and banking in Uzbekistan and Central Asia. His purpose is to raise public and entrepreneurial awareness of Islamic financing and banking, consequently improving living circumstances and assuring long-term economic prosperity of Muslim.",
      description_uz:"HAMID RAHAMTOV Malayziyaning Kuala-Lumpur shahridagi Xalqaro islom universiteti Malayziya universitetida islom moliyasi bo‘yicha magistrlik darajasini oldi. U moliyaviy xizmatlar, sug'urta va davlat sohalarida katta tajribaga ega. Bundan tashqari, u islomiy moliya bo'yicha tez-tez maqolalar tayyorlaydigan va bu sohada ham ko'plab o'quv mashg'ulotlarini olib boruvchi akademik. Xamid o'z jamoasi bilan birga O'zbekiston va Markaziy Osiyoda islom moliyasi va bankining umumiy rivojlanishiga faol hissa qo'shish niyatida. Uning maqsadi aholi va tadbirkorlarning islomiy moliyalashtirish va bank ishi bo'yicha xabardorligini oshirish, natijada musulmonlarning turmush sharoitini yaxshilash va uzoq muddatli iqtisodiy farovonligini ta'minlashdan iborat."
    },
    {
      id: 3,
      name: 'Oybek Khojimamatov',
      position:"",
      phone: '+998(55) 502-22-99',
      email: 'sattarov@immu.uz',
      image: Person3,
      description_en:"Oybek Khojimamatov holds a B.S. in Accounting from the University of South Florida, USA, and has earned CPSS and CPFAS certifications from AAOIFI. He has a strong foundation in accounting and Islamic finance, with particular interest in Shariah-compliant financial practices and financial literacy.",
