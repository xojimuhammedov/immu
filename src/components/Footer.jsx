    ...
    <footer className="bg-teal-600 text-white py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="flex flex-wrap justify-center gap-4 sm:gap-8 mb-4 md:mb-0">
          <a href="#" className="text-sm hover:text-white/80 transition">
            HOME
          </a>
          <a href="#" className="text-sm hover:text-white/80 transition">
            ABOUT IMMU
        ...
        <div className="flex space-x-6">
          <a
            href="#"
            className="w-10 h-10 border flex items-center justify-center border-white rounded-full hover:text-white/80 transition"
          >
          ...
          <a
            href="#"
            className="w-10 h-10 border flex items-center justify-center border-white rounded-full  transition  "
          >
