      ...
      <div className="flex flex-col md:flex-row gap-4 items-start">
        ...
        <div className="w-full md:w-2/3">
          <h1 className="font-inter font-bold text-[32px] leading-[120%] tracking-[0] mb-4 text-[#062A49]">
            Kolumbiyada oʻtgan jahon championatida hamyurtimiz ilk medalni
            qoʻlga kiritdi
          </h1>
          <img
            src={veloImg}
          ...
          <p className="font-inter font-normal text-[16px] leading-[120%] tracking-[0.2px] text-justify text-[#5D6B8A] mt-3">
            ...
            bo‘yicha o‘tkazilgan jahon chempionatida 87 kilogramm vazn toifasida
            ishtirok etgan O‘zbekiston terma jamoasi a’zosi Tursunoy Jabborova
            kumush va bronza medallarini qo‘lga kiritdi, deb xabar bermoqda
            “Dunyo” axborot agentligi muxbiri.
          </p>
          ...
          <p className="font-inter font-normal text-[16px] leading-[110%] tracking-[0.2px] text-justify text-[#5D6B8A]">
            Yoshligimda boshqa bolalar kabi sho‘h bo‘lmaganman. Ulg‘ayganim sari
            kishilar o‘rtasidagi munosabatlarning yaxshi-yomon taraflariga
            e’tibor berar, nega bu vaziyatda unaqa, bunaqa? – degan savollarni
            ota-onamga ko‘p berardim. Bolaligimdan tarix kitoblarini o‘qish va
            sayohat qilishni yaxshi ko‘rar edim. Bundan tashqari, siyosatga va
            ijtimoiy psixologiyaga juda katta qiziqishim bo‘lgan. Uyimizda doim
            siyosiy mavzularda suhbatlar ko‘p bo‘lardi. Oilaviy muhitim bu
            yo‘nalishlarga qiziqishimni yanada oshirgan. Davlatlar, bir guruh
            shaxslar o‘rtasidagi munosabatlar, davlatlarning rivojlanish yoki
            qulashini sabab va konuniyatlarini tushinish va anglashni istab, shu
            yo‘nalishni tanlaganman.
          </p>
          <p className="font-inter font-normal text-[16px] leading-[110%] tracking-[0.2px] text-justify text-[#5D6B8A] mt-4">
            ...
            universitetining Jahon siyosati yunalishini tugatganman. Diplom
            ishim mavzusi Xitoy Xalk Respublikasi siyosatiga
            bag‘ishlangan.-Hozirda, Italiyaning Rim shahrida joylashgan
            Yevropaning eng katta, qadimgi va nufuzli oliy o‘quv yurtlaridan
            bo‘lgan “Sapienza University of Rome”da magistratura bosqichida
            “Rivojlanish va xalqaro hamkorlik”yo‘nalishida tahsil olmoqdaman.
          </p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex flex-col gap-5 ">
                <p className="font-inter font-bold text-[13px] leading-[125%] tracking-[0.2px] text-[#10131B]">
                  1 daqiqa o‘qish Xorijda istiqomat qilayotgan vatandoshlarning
                  nafaq...
                </p>
                <div className="flex justify-between">
                  <div className="flex items-center space-x-1 text-xs text-[#5D6B8A]">
                    <DateIcon />
                    <span>12.02.2023</span>
                  </div>
