    ...
    <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] max-w-7xl mx-auto mt-5 overflow-hidden rounded-2xl">
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-end md:items-end p-5 sm:p-6 h-full text-white">
        ...
        <div className="hidden md:flex space-x-3 mt-6 md:mt-0">
          <button
            onClick={prevSlide}
            className="bg-white bg-opacity-20 backdrop-blur-sm hover:bg-opacity-30 text-[#009688] border border-white border-opacity-30 w-[48px] h-[48px] flex justify-center items-center hover:bg-[#009688] hover:text-white rounded-full transition duration-300 shadow-md"
          >
            <ChevronLeft size={20} />
          </button>
          <button
