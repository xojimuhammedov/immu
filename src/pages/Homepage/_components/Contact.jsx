                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="text-white">
                        ...
                        <div className="space-y-4">
                            {/* <div className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                                ...
                                <div>
                                    <p className="text-sm text-slate-400">{t("Telefon raqam")}</p>
                                    <p className="text-white font-medium">{"+998 71 123 45 67"}</p>
                                </div>
                            </div> */}
                            <div className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                                <div className="w-12 h-12 bg-emerald-500/20 rounded-lg flex items-center justify-center">
                    ...
                    <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Organization Field */}
                            <div className="space-y-2">
                                <label htmlFor="organization" className="text-slate-700 font-medium flex items-center gap-2 text-sm">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="phone" className="text-slate-700 font-medium flex items-center gap-2 text-sm">
                                            ...
                                            <div className="absolute top-full left-0 mt-1 w-64 max-h-72 overflow-y-auto bg-white border border-slate-200 rounded-xl shadow-lg z-50">
                                                {countryCodes.map((country, index) => (
                                                    <button
                                                        ...
                                                        className={`w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-emerald-50 transition-colors ${selectedCountry.code === country.code && selectedCountry.country === country.country
                            ...
                            {/* Message Field */}
                            <div className="space-y-2">
                                <label htmlFor="message" className="text-slate-700 font-medium flex items-center gap-2 text-sm">
