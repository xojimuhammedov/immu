...
const Fond = () => {
  return (
    <div className=" mt-10">
      ...
      <div className="max-w-7xl mx-auto ">
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="w-full md:w-1/2 h-full  flex flex-col gap-8">
            <h2 className="text-[#009688] font-bold text-[28px] leading-[100%] tracking-[0%] font-inter ">
            ...
            <p className="text-gray-600 leading-relaxed font-normal text-[16px]  tracking-[0.2px] font-inter ">
              ...
              qolish, vatandoshlar va ular tomonidan tuzilgan jamoat
              birlashmalarini qo‘llab-quvvatlash, turli sohalarda faoliyat
              ...
              Xorijda istiqomat qilayotgan vatandoshlarni tarixiy Vatani
              atrofida yanada jipslashtirish, ularning qalbi va ongida yurt
              bilan faxrlanish tuyg‘usini yuksaltirish.
            </p>
            <button className="bg-[#009688] text-white w-[140px] h-[48px] rounded-2xl hover:bg-[#00796b] transition duration-300">
              Batafsil
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-10 border-b border-[#2B2B2B99] px-4">
        <div className="flex flex-wrap">
          ...
          <div className="w-1/2 lg:w-1/4 h-[107px] border-x border-[#2B2B2B99] mb-4">
            <h2 className="font-bold text-[40px] sm:text-[48px] lg:text-[60px] leading-[75px] tracking-[1%] text-center font-inter">
              12<span className="text-[#009688]">+</span>
            </h2>
          ...
          <div className="w-1/2 lg:w-1/4 h-[107px] border-x border-[#2B2B2B99] mb-4">
            <h2 className="font-bold text-[40px] sm:text-[48px] lg:text-[60px] leading-[75px] tracking-[1%] text-center font-inter">
              <span className="text-[#009688]">+</span>20K
            </h2>
            <h3 className="font-normal text-[18px] sm:text-[20px] lg:text-[22px] leading-[100%] tracking-[1%] text-center font-inter">
              Cargo Delivered
            </h3>
