...
import { NotebookIcon,EyeIcon } from 'lucide-react';
const News = () => {
  const newsItems = [
    {
      id: 1,
  ...
  return (
    <div className="p-0 mt-10 max-w-7xl mx-auto">
      {/* Section Title */}
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Yangiliklar</h2>
            ...
            >
              ...
              <div className="flex-1 p-2 md:p-4 flex flex-col justify-between">
                ...
                <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                   <div className='flex'>
                      <NotebookIcon className='w-5 h-4'/> 
                  <span>{item.date}</span>
                   </div>
