...
const News = () => {
  const newsItems = [
    ...
    },
    {
      id: 2,
      title:
        'Bugungi loyihamiz qahramonlari Yaponiyaning Nagoya shahrida istiqomat qilayotgan Avezovla...',
      date: '12.02.2023',
      image: NewsImage1,
      likes: 100,
    },
    {
      id: 3,
      title:
        'Xorijdagi vatandoshlar ishtirokida "Navro’z" bayrami tantanaları boshlandi',
      date: '12.02.2023',
      image: NewsImage2,
      likes: 100,
    },
  ...
  return (
    <div className="p-0 mt-10 max-w-7xl mx-auto">
      {/* Section Title */}
      <h2 className="text-2xl md:text-[45px] font-bold text-gray-800 mb-6">
        Yangiliklar
      </h2>
          ...
          {newsItems.slice(1).map(item => (
            ...
            >
              ...
              <div className="flex-1 p-2 md:p-4 flex flex-col justify-between">
                <h3 className="font-bold text-[12px] md:text-[16px] leading-[155%] tracking-[0.2px] font-inter text-[#009688] line-clamp-3">
                  {item.title}
                </h3>
